document.addEventListener('DOMContentLoaded', function () {
  // Cargar el tema guardado en el localStorage
...
// Reacciones: Hacer que el botón de reacciones cambie de color cuando se clickea
const reactions = document.querySelectorAll('.reaccion');
